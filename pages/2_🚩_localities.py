...
all_localities=[]
params_2 = {"name": mineral, "id":id, "ima_status": "APPROVED", "format": "json"}
try:
    response = requests.get(MINDAT_API_URL + f"/https://api.mindat.org/minerals_ima/{id}/", params=params_2, headers=headers)
